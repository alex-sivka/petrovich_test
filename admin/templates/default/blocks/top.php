...
<nav class="navbar navbar-inverse navbar-static-top" id="top_menu">
	<div class="container-fluid">
		...
		<header class="navbar-header">
			...
			<a href="/" target="_blank" class="navbar-brand"><img src="/<?=ADM_DIR?>/assets/images/logo_ss.png" alt=""></a>
		</header>

		<div class="topnav">
			<div class="btn-group">
				<a class="btn btn-default btn-sm" href="/<?=ADM_DIR?>/components/dashboard/edit/"> <span class="fa fa-cog"></span>  </a>
			</div>
			<div class="btn-group">
